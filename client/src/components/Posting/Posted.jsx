  ...
  const handleDelete = async (postId) => {
    ...
    try {
      ...
      const response = await axios.delete(
        `/experiences/updateAExperience/${postId}`
      );
  ...
  if (loadingDelete) {
    ...
    return (
      <div className='mx-auto mb-20 max-w-7xl px-4 sm:px-6 lg:px-8 overflow-hidden bg-white py-5 sm:rounded-lg'>
        <div className='flex justify-between mx-auto max-w-2xl p-2 ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none'>
          <div role='status'>
            <svg
              aria-hidden='true'
  ...
  return (
    <div className='mx-auto mb-20 max-w-7xl px-4 sm:px-6 lg:px-8 overflow-hidden bg-white py-5 sm:rounded-lg'>
      {userPosts.map((post) => (
        <div
          key={post._id}
          className='flex justify-between mx-auto max-w-2xl p-2 ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none'
        >
